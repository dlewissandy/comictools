...
ROOT_PATH_TEMPLATES[Setting.__name__] = ROOT_PATH_TEMPLATES[SelectedKind.SETTING.value]
...
PATH_TEMPLATES[Setting.__name__] = PATH_TEMPLATES[SelectedKind.SETTING.value]
...
FILEPATH_TEMPLATES[Setting.__name__] = FILEPATH_TEMPLATES[SelectedKind.SETTING.value]
